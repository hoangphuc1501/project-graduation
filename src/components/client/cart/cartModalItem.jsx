        ...
        <>
            <div className="py-[20px] border-b px-[10px]">
                <div className="flex justify-between">
                    <div className="w-[30%] h-[125px] rounded-[12px] overflow-hidden">
                        <img src="https://static.fbshop.vn/wp-content/uploads/2024/05/Tag-2-1.jpg" alt="" className="w-full h-full" />
                    </div>
                    <div className="w-[67%]">
                        <Link to="*" className="text-[16px] text-[#000000] font-[700] mb-[8px] leading-[1.4] line-clamp-2 hover:text-main">
                            Vợt Cầu Lông Lining Halbertec Motor | Phiên bản đặc biệt
                        </Link>
                        <div className="flex gap-[10px] items-center mb-[8px]">
                            <span className="text-[14px] text-[#000000] font-[400] ">Màu: đỏ</span>
                            <span>/</span>
                            <span className="text-[14px] text-[#000000] font-[400] ">Size: m</span>
                        </div>
