...
const CreateModalColor = (props) => {
    const {showCreateColor, setShowCreateColor, refreshColor} = props;
    const handleClose = () => setShowCreateColor(false);
    ...
    const handleCreateColor = async (e) => {
        ...
        try {
            const response = await laravelAPI.post("/api/admin/colors", {
                name,
            ...
            >
                ...
                <Modal.Body>
                    <form onSubmit={handleCreateColor}>
                        <h2 className='text-[24px] text-[#000000] font-[700] text-center pb-[20px]'>Thêm mới màu sắc</h2>
...
export default CreateModalColor;