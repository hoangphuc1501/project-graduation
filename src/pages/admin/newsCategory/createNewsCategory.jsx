...
const CreateNewsCategory = (props) => {
    const { showCreateCategoryModal, setShowCreateCategoryModal, fetchNewsCategory } = props;
    ...
    // tạo danh mục mới
    const handleCreateCategoryNews = async (e) => {
        e.preventDefault();
        // console.log("Giá trị parentID trước khi gửi API:", formData.parentID);
        try {
            const response = await laravelAPI.post("/api/admin/newscategories", {
                name: formData.name,
    ...
    return (
        <>
            ...
            >
                ...
                <Modal.Body>
                    <form onSubmit={handleCreateCategoryNews}>
                        ...
                        <div className='px-[10px] mb-[20px] flex flex-col'>
                            <label className='text-[18px] text-[#000000] font-[700] pb-[8px]'>Danh mục bài viết cha</label>
                            <select
