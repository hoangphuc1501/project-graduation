...
const CreateNews = (props) => {
    const { showCreateNewsModal, setShowCreateNewsModal, fetchNews } = props;
    ...
    const handleCreateNews = async (e) => {
        ...
        try {
            const response = await laravelAPI.post("/api/admin/news", {
                title: formData.title,
                content: content, // từ TextEditor
            ...
            >
                ...
                <Modal.Body>
                    <form onSubmit={handleCreateNews}>
                        <h2 className='text-[24px] text-[#000000] font-[700] text-center pb-[20px]'>Thêm mới bài viết</h2>
