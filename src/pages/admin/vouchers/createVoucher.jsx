...
const CreateVoucher = (props) => {
    const { showCreateVoucherModal, setShowCreateVoucherModal, fetchVouchers } = props;
    ...
    const handleClose = () => setShowCreateVoucherModal(false);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await laravelAPI.post("/api/admin/vouchers", formData);
            // console.log("check create voucher", response)
