...
const EditCategory = (props) => {
    const { showEditCategoryModal, setShowEditCategoryModal, fetchProductCategory, categoryId } = props;
    ...
    const handleUpdateCategory = async (e) => {
        ...
        try {
            const response = await laravelAPI.patch(`/api/admin/productcategories/${categoryId}`, {
                name: formData.name,
